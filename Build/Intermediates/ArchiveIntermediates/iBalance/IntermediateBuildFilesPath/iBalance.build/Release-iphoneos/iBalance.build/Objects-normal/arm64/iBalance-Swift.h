...
@property (nonatomic, weak) IBOutlet UILabel * __null_unspecified pathLengthInfo;
@property (nonatomic, weak) IBOutlet UILabel * __null_unspecified countdownLabel;
@property (nonatomic, weak) IBOutlet UILabel * __null_unspecified totalPathLength;
@property (nonatomic, strong) CMMotionManager * __null_unspecified motionManager;
...
- (IBAction)startTimer:(UIButton * __nonnull)sender;
- (void)resetValues;
- (IBAction)sendMail:(UIButton * __nonnull)sender;
- (IBAction)graphData:(id __nonnull)sender;
